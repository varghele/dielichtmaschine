...
Being standalone raises two questions the QLC+-extension plan used to answer: where fixture definitions come from, and how the app talks to the rest of a rig. This milestone is the groundwork. Nothing here commits to a format switch until the spike says so. It also carries the identity half of the pivot: the app stops presenting itself as a QLC+ companion.
